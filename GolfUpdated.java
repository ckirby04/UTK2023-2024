...
class GolfUpdated {
   public static void main(String[] args) {
      ...
      player2holes = new ArrayList<>(SHORT_GAME); // Java doesn't actually need the SHORT_GAME part, could leave it like ();
      ...
      /* See if scores are correct by looping through the players' respective ArrayLists */
      /* We can use the .size() METHOD HERE with an ArrayList - as a reminder, remember arrays use .length, not .size() 
         and we can use the .get() METHOD HERE to retrieve elements from the ArrayList
         .get() will take an index as a parameter, and give us what is stored at that index back.
         REMEMBER 0-indexing! */
